...
describe("Form", () => {
  ...
  it("validates that the student name is not blank", () => {
    ...
    let {getByText} = render(<Form  interviewers={interviewers} onSave={()=> onSave()}/>)
  ...
  it("validates that the interviewer cannot be null", () => {
    ...
    let {getByText} = render(<Form interviewers={interviewers} onSave={()=> onSave()} student="Lydia Miller-Jones"/>)
